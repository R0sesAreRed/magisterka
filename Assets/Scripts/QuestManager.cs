...
public class QuestManager : MonoBehaviour
{
    ...
    public void Save(List<QuestData> items) //to trzeba doda� w miejscach ktore tego potrzebuja
    {
...
// przejd� melodi� z 100% trafie�                                   //100hits +
// w trakcie jednej melodii traf 5 perfekcyjnych trafie�            //perfecthits +
// w trakcie jednej melodii traf 10 perfekcyjnych trafie�           //pefrecthits +
// w trakcie jednej melodii traf 15 perfekcyjnych trafie�           //perfecthits +
// w trakcie jednej melodii osi�gnij 60% maksymalnego wyniku        //score +
// zdob�d� osi�gni�cie                                              //achievement
// uko�cz melodi�                                                   //melodiefinish +
// uko�cz 3 melodie                                                 //melodiefinish +
// uko�cz 5 melodii                                                 //melodiefinish +
